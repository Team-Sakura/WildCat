...
module.exports.run = async (bot, message, args) => {
    ...
    .setColor('RED')
    .setTitle('Error')
    .setDescription('Не указано описание идеи'))


    let embed = new Discord.MessageEmbed()
    .setColor("GREEN")
    .setTitle("Ваша идея успешно отправлена!")
    .setFooter("Все идеи приходят разработчику",message.author.avatarURL())
...
module.exports.help = {
    name: 'idea',
    aliases: ['идея'],
    description: 'Отправить идею создателю',
    category: 'Утилиты',
    usages: {'!idea text': 'Отправить сообщение об идеи' }
};